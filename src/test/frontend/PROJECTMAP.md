...
| `git-view.test.js` | The dashboard's Git view: the repository header, the grouped action bar and the single-rail history. |
...
- A green frontend suite says nothing about whether a module is **loaded** by the page. That is the host's
  declared list, and it is checked on the other side.
